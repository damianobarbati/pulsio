...
- Leave 1 blank line between two methods inside a class.
- Leave 1 blank line between distinct route definitions.
- Leave 1 blank line before control blocks (if, for, try/except).
- Leave 1 blank line before block explanatory comments.
