...
import { Button, KpiCard, Select } from 'ui';
  ...
  return (
    <>
      <div className="mb-5 flex flex-wrap items-center justify-between gap-4">
        <h1 className="mr-auto font-semibold text-3xl tracking-tight sm:text-4xl">Here’s what’s happening with your websites.</h1>
        <div className="flex flex-wrap items-center gap-3">
          <label className="flex items-center gap-2">
            ...
            <Select
              ...
              className="w-auto max-w-60 font-semibold text-base"
            >
              {sites.map((site) => (
      ...
      {data && !paymentRequired && (
        <>
          <div className="mb-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <KpiCard label="Live now" value={live.data?.activeVisitors ?? '…'} detail="visitors on your site" live />
            <KpiCard label="Visitors" value={formatMetric('visitors', data.summary.visitors)} detail="vs. previous period" />
            <KpiCard label="Page views" value={formatMetric('pageviews', data.summary.pageviews)} detail="vs. previous period" />
            <KpiCard label="Bounce rate" value={formatMetric('bounceRate', data.summary.bounceRate)} detail="vs. previous period" />
          </div>
