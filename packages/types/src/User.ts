...
export const UserRowSchema = z
  .object({
    ...
    login_at: z.string().datetime({ offset: true }).nullable(),
    password_changed_at: z.string().datetime({ offset: true }),
    ...
    email_verification_expires_at: z.string().datetime({ offset: true }).nullable(),
    trial_ends_at: z.string().datetime({ offset: true }),
