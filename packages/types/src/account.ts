...
export const registrationSchema = z.object({
  ...
  plan: z.enum(['start', 'grow', 'scale']).default('start'),
});
...
export const siteSetupSchema = z.object({ id: z.uuid(), domain: z.string(), detected: z.boolean(), snippet: z.string(), adminUrl: z.url() });
...
export type SiteRow = { id: string; account_id: string; domain: string; detected_at: string | null };
