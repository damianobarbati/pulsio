        ...
        <ol className="mt-10 space-y-6">
          ...
          <li className="rounded-2xl border border-ink/15 bg-white p-7">
            ...
            <details className="mt-4 text-sm">
              ...
              <p className="mt-3 text-ink/70">
                Check that your changes are published and the snippet is present in your page source. The same snippet can track all your domains. A browser extension or content
                security policy may block the script. Try a browser with extensions disabled.
              </p>
            </details>
          </li>
